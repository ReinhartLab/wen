...
def run_correlation(raw_MEG, freq, fStr, fwd, subjects_dir, subject):
...
def run_subject_in_parallel(subjects_dir, subject, volume_spacing, freqStr, freqBand):
    ...
    run_correlation(raw_MEG, freqBand, freqStr, fwd, subjects_dir, subject)
...
def main():
    ...
    for subject in case_list:
        pool.apply_async(run_subject_in_parallel, args=[subjects_dir, subject, volume_spacing, freqStr, freqBand])
    pool.close()
    pool.join()
